...
* Low band-passed LFP: 1 x time > ><br/>
...
#### **3.1.4 Label CSs in a PC recording**
**Selecting a CS**
...
#### **3.1.5 Save the CS labels for each PC**
...
After labeling all the uploaded files, press the **'Save'** button in the Save training data section. This will not save the full span of the recording, but automatically select only the selected CS spans and some time before and after them from each file to include non-CS spans. This is done to reduce the data size, hence speeding up the training process.
 ...
 [back to top](#top)
### <a name="step2">**3.2 STEP 2: Training the network**</a>
...
### <a name="step3">**3.3 STEP 3: Detecting complex spikes**</a>
...
In this mode, the detection process runs on a single PC recording. This allows you to check the algorithm's performance in detecting CSs in a particular PC test dataset. If the performance is not up to your standards, you may consider adjusting the Advanced parameter settings discussed in section 3.2.4.  <br/>
*    **3.3.3.1 Upload file**
...
* **3.3.4.2 Select the target folder for saving the output**
